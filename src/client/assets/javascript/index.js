...
// To start run - ./bin/server-windows-amd64.exe ORIGIN_ALLOWED=http://localhost:3000
...
function renderRaceStartView(track, racers) {
  // const track1 = await getTracks();
  // const racers1 = await getRacers();
